...
/**
 * ------------> : Realizacion: Se refiere a la implementacion de un comportamiento definido en otro elemento 
 * ____________> : Delegacion: Se refiere al acceso al estado y comportamiento de un objeto desde otro objeto
 */
